...
<head>
    ...
    <!-- Stylesheets -->
    <link rel="stylesheet" href="{{url('/vendors/remark/global/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{url('/vendors/remark/global/css/bootstrap-extend.min.css')}}">
    <link rel="stylesheet" href="{{url('/vendors/remark/base/assets/css/site.min.css')}}">
    <!-- Plugins -->
    <link rel="stylesheet" href="{{url('/vendors/remark/global/vendor/animsition/animsition.css')}}">
    <link rel="stylesheet" href="{{url('/vendors/remark/global/vendor/asscrollable/asScrollable.css')}}">
    <link rel="stylesheet" href="{{url('/vendors/remark/global/vendor/switchery/switchery.css')}}">
    <link rel="stylesheet" href="{{url('/vendors/remark/global/vendor/intro-js/introjs.css')}}">
    <link rel="stylesheet" href="{{url('/vendors/remark/global/vendor/slidepanel/slidePanel.css')}}">
    <link rel="stylesheet" href="{{url('/vendors/remark/global/vendor/flag-icon-css/flag-icon.css')}}">
    <!-- Fonts -->
    <link rel="stylesheet" href="{{url('/vendors/remark/global/fonts/web-icons/web-icons.min.css')}}">
    <link rel="stylesheet" href="{{url('/vendors/remark/global/fonts/brand-icons/brand-icons.min.css')}}">
    ...
    <![endif]-->
    <!-- Scripts -->
    <script src="{{url('/vendors/remark/global/vendor/modernizr/modernizr.js')}}"></script>
    <script src="{{url('/vendors/remark/global/vendor/breakpoints/breakpoints.js')}}"></script>
    <script>
        Breakpoints();
    </script>
</head>
        ...
        <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
                                        ...
                                        <ul class="blocks-3">
                                            <li>
                                                <a class="thumbnail margin-0" href="javascript:void(0)">
                                                    <img class="width-full" src="{{url('/vendors/remark/global/photos/placeholder.png')}}" alt="..."
                                                    />
                                                </a>
                                            </li>
                                            <li>
            ...
            <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
              ...
              <span class="avatar avatar-online">
                <img src="{{url('/vendors/remark/global/portraits/5.jpg')}}" alt="...">
                <i></i>
              </span>
                    </a>
                    <ul class="dropdown-menu" role="menu">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right dropdown-menu-media" role="menu">
                        ...
                        <li class="list-group" role="presentation">
                          ...
                          <span class="avatar avatar-sm avatar-online">
                            <img src="{{url('/vendors/remark/global/portraits/2.jpg')}}" alt="..." />
                            <i></i>
                          </span>
                                            </div>
                                            <div class="media-body">
                          ...
                          <span class="avatar avatar-sm avatar-off">
                            <img src="{{url('/vendors/remark/global/portraits/3.jpg')}}" alt="..." />
                            <i></i>
                          </span>
                                            </div>
                                            <div class="media-body">
                          ...
                          <span class="avatar avatar-sm avatar-busy">
                            <img src="{{url('/vendors/remark/global/portraits/4.jpg')}}" alt="..." />
                            <i></i>
                          </span>
                                            </div>
                                            <div class="media-body">
...
<!-- Core  -->
<script src="{{url('/vendors/remark/global/vendor/jquery/jquery.js')}}"></script>
<script src="{{url('/vendors/remark/global/vendor/bootstrap/bootstrap.js')}}"></script>
<script src="{{url('/vendors/remark/global/vendor/animsition/animsition.js')}}"></script>
<script src="{{url('/vendors/remark/global/vendor/asscroll/jquery-asScroll.js')}}"></script>
<script src="{{url('/vendors/remark/global/vendor/mousewheel/jquery.mousewheel.js')}}"></script>
<script src="{{url('/vendors/remark/global/vendor/asscrollable/jquery.asScrollable.all.js')}}"></script>
<script src="{{url('/vendors/remark/global/vendor/ashoverscroll/jquery-asHoverScroll.js')}}"></script>
<!-- Plugins -->
<script src="{{url('/vendors/remark/global/vendor/switchery/switchery.min.js')}}"></script>
<script src="{{url('/vendors/remark/global/vendor/intro-js/intro.js')}}"></script>
<script src="{{url('/vendors/remark/global/vendor/screenfull/screenfull.js')}}"></script>
<script src="{{url('/vendors/remark/global/vendor/slidepanel/jquery-slidePanel.js')}}"></script>
<!-- Scripts -->
<script src="{{url('/vendors/remark/global/js/core.js')}}"></script>
<script src="{{url('/vendors/remark/base/assets/js/site.js')}}"></script>
<script src="{{url('/vendors/remark/base/assets/js/sections/menu.js')}}"></script>
<script src="{{url('/vendors/remark/base/assets/js/sections/menubar.js')}}"></script>
<script src="{{url('/vendors/remark/base/assets/js/sections/gridmenu.js')}}"></script>
<script src="{{url('/vendors/remark/base/assets/js/sections/sidebar.js')}}"></script>
<script src="{{url('/vendors/remark/global/js/configs/config-colors.js')}}"></script>
<script src="{{url('/vendors/remark/base/assets/js/configs/config-tour.js')}}"></script>
<script src="{{url('/vendors/remark/global/js/components/asscrollable.js')}}"></script>
<script src="{{url('/vendors/remark/global/js/components/animsition.js')}}"></script>
<script src="{{url('/vendors/remark/global/js/components/slidepanel.js')}}"></script>
<script src="{{url('/vendors/remark/global/js/components/switchery.js')}}"></script>
<script>
